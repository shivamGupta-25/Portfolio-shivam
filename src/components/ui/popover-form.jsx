  ...
  return (
    (<div
      ...
      <motion.button
        ...
        className="flex h-9 items-center border border-input bg-foreground px-3 text-md font-bold text-primary-foreground outline-none">
        ...
        {open && (
          <motion.div
            ...
            <div className="relative z-10">
              ...
              <div 
                className="p-1 overflow-hidden bg-muted shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none"
